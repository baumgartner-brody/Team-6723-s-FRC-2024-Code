...
public class Idle extends Command {
    ...
    private final double IDLE_POSITION_LOWER_BOUND = -0.55;
    private final double IDLE_POSITION_UPPER_BOUND = -0.45;
