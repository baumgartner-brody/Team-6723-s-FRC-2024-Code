...
public class IntakeQuick extends Command {
    ...
    public IntakeQuick(intakeSubsystem sparkMax3, double speed) {
    ...
    public IntakeQuick(intakeSubsystem sparkMax3, double speed, double time) {
        s_sparkmax3 = sparkMax3;
        addRequirements(s_sparkmax3);
        _speed = speed;
        _time = time;
