...
public class LowerArm2 extends Command {
    ...
    private final double SPEED_MIN = 0.00005;
    private final double SPEED_MAX = 0.015; // Speed to apply to the motors 
    ...
    private final double ENCODER_VELOCITY_MAX = 1000; // Encoder readings
    ...
    public void execute() {
        ...
        double average_encoder_position = (Math.abs(Robot.encoder_data.sparkMax5_rev) + Math.abs(Robot.encoder_data.sparkMax6_rev)) / 2.0;
    ...
    public void end(boolean interrupted) {
        s_sparkmax.stop();
        System.out.println("LowerArm2 Is complete");
    }
}
